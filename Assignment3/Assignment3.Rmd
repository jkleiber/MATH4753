...
a) The interval can be found from the sample in R using `qnorm` to find the Z value $z_{0.005}$:
```{r}
lead_mean = mean(leadcopp$LEAD)
lead_mean
lead_sd = sd(leadcopp$LEAD)
lead_sd
z005 = qnorm(0.005, mean = lead_mean, sd = lead_sd)
z005

lower = lead_mean - z005*lead_sd/sqrt(10)
upper = lead_mean + z005*lead_sd/sqrt(10)
